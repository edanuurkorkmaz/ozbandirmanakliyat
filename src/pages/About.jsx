    ...
    <>
      ...
      <section className="py-20 bg-neutral-100 ">
        <div className="max-w-7xl mx-auto px-6 space-y-20">
          <div className="bg-white rounded-xl flex justify-center text-center items-center gap-5 p-8">
            <div className="bg-white  p-5 flex-col items-center justify-items-center ">
              <View className="text-[#3C303F] mb-10" size={100} />
            ...
            <div className="bg-white p-5  flex-col items-center justify-items-center">
              <Rocket className="text-[#3C303F] mb-10" size={100} />
              <h3 className="text-2xl font-bold mb-6 text-gray-800">
                Misyonumuz
              </h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white  p-5  flex-col items-center justify-items-center">
              <Gem className="text-[#3C303F] mb-10" size={100} />
              <h3 className="text-2xl font-bold mb-6 text-gray-800">
                Değerlerimiz
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Faaliyetlerimizin temelinde güven, şeffaflık ve profesyonellik
                yer alır. Üretici firmalar ile taşıyıcılar arasında kurduğumuz
                iş birliklerinde açık iletişim ve dürüstlükten ödün vermeden
                hareket ederiz. Süreçleri doğru planlama ve zaman yönetimi ile
                organize ederek verimli ve sürdürülebilir çözümler sunarız.
                Müşteri odaklı yaklaşımımızla her operasyonu titizlikle ele
                alır, iş ortaklarımıza değer katan, uzun vadeli ve güçlü
                ilişkiler kurmayı hedefleriz.
              </p>
            </div>
          </div>
